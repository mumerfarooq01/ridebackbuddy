      ...
      <section className="py-16 px-4">
        <div className="max-w-6xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <div className="space-y-4 text-gray-400 leading-relaxed">
                ...
                <p>
                  ...
                  <span className="text-white font-medium">two drivers</span> on
            ...
            >
              {[
                { icon: Award, value: "13+", label: "Years of Service", color: "text-gold" },
          ...
          <div className="relative">
            ...
            <div className="space-y-8">
              {milestones.map((m, idx) => (
                ...
                >
                  <div className="w-10 h-10 rounded-full bg-accent-red/20 border-2 border-accent-red flex items-center justify-center flex-shrink-0 z-10">
                    <CheckCircle2 className="w-4 h-4 text-accent-red" />
                  </div>
                  <div>
                    <span className="text-gold font-semibold">{m.year}</span>
                    <p className="text-gray-400 mt-1">{m.event}</p>
                  </div>
                </motion.div>
              ))}
            </div>
      ...
      <section className="py-20 px-4">
        <div className="max-w-4xl mx-auto">
          <motion.div
            ...
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true }}
            className="glass rounded-2xl p-10 md:p-14 text-center relative overflow-hidden"
          >
            ...
            <div className="relative z-10">
              ...
              <a
                href="/contact"
                className="inline-flex items-center gap-2 bg-gradient-gold hover:opacity-90 text-navy px-8 py-4 rounded-xl font-semibold text-lg transition-all duration-200 hover:scale-105 shadow-xl shadow-gold/25"
              >
                Apply Now
              </a>
            </div>
