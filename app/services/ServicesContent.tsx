        ...
        <div className="max-w-6xl mx-auto space-y-12">
          {services.map((service, idx) => (
            <motion.div
              ...
              className="bg-white border border-mist shadow-sm rounded-2xl p-8 md:p-10"
            >
              <div className="flex flex-col lg:flex-row gap-8">
                ...
                <div className="lg:w-80 shrink-0">
                  <div className="bg-mist/30 rounded-xl p-6 border border-mist">
                    ...
                    <div className="space-y-3">
                      {service.pricing.map((p) => (
                        <div key={p.label} className="flex items-center justify-between text-sm">
                          ...
                          <span className="text-navy font-semibold">{p.value}</span>
                        </div>
                      ))}
                    </div>
                  </div>
            ...
            {faqs.map((faq, idx) => (
              ...
              >
                <button
                  ...
                  className="w-full flex items-center justify-between px-6 py-5 text-left hover:bg-mist/50 transition-colors"
                >
                  <span className="text-navy font-medium pr-4">{faq.q}</span>
                  <ChevronDown
